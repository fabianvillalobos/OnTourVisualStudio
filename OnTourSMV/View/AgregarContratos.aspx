    ...
    <center>
        <table style="width: 75%;">
            <tr>
                ...
                <td>Fecha Inicio</td>
                <td><asp:TextBox ID="txtInicio" runat="server" TextMode="Date"></asp:TextBox></td>
                <td>Fecha Termino</td>
                <td><asp:TextBox ID="txtFin" runat="server" TextMode="Date"></asp:TextBox></td>
            </tr>
            <tr>
                <td>Meta</td>
                <td><asp:TextBox ID="txtMeta" runat="server" TextMode="Number"></asp:TextBox></td>
                <td>Monto</td>
