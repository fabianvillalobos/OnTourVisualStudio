...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="NUMRUT_CLI" DataSourceID="SqlDataSourceListarCliente">
        <Columns>
            ...
            <asp:BoundField DataField="ID_USR" HeaderText="Usuario" SortExpression="ID_USR" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceListarCliente" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;CLIENTE&quot;"></asp:SqlDataSource>
</asp:Content>
